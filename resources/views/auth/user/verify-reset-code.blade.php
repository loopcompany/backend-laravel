                    ...
                    <div
                        ...
                        <div class="p-3 p-lg-5">
                            ...
                            <div class="text-center">
                                <h2 class="fw-bold fs-3">تایید کد بازیابی</h2>
                    ...
                    <div class="col-12 col-lg-6 m-auto">
                        <div class="row my-5">
                            <div class="col-sm-10 col-xl-8 m-auto">
                                ...
                                <h1 class="fs-4">تایید کد بازیابی</h1>
                                <p class="mb-4">
                                    کد تایید به شماره <strong>{{ session('phone') }}</strong> ارسال شد. 
                                    کد ۶ رقمی را در زیر وارد کنید.
                                </p>

                                <!-- Form START -->
                                <form method="POST" action="{{ route('web.verify-reset-code') }}">
                                    @csrf
                                    ...
                                    <div class="align-items-center mt-0">
                                        <div class="d-grid">
                                            <button class="btn btn-primary mb-0" type="submit">تایید و ورود</button>
                                        </div>
                                    </div>
                                </form>
                                <!-- Form END -->
                                ...
                                <div class="mt-4 text-center">
                                    <form method="POST" action="{{ route('web.resend-reset-code') }}" class="d-inline">
                                        @csrf
                                ...
                                <div class="mt-4 text-center">
                                    <span>اطلاعات اشتباه وارد کردید؟ <a href="{{ route('web.forgot-password') }}">تلاش مجدد</a></span>
                                </div>
                            </div>
                        </div> <!-- Row END -->
                    </div>
