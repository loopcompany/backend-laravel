...
class LeaveRequestResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'درخواست‌های مرخصی';
    ...
    {
        return 'edit-leave-requests';
    }

    protected static function getDeletePermission(): string
    {
        return 'delete-leave-requests';
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('جزئیات مرخصی')
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('to_date')
                            ->label('تاریخ پایان')
                            ->disabled(),

                        Forms\Components\TextInput::make('houre')
                            ->disabled()
                            ->label('ساعت'),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('houre')
                    ->label('ساعت')
                    ->placeholder('-'),
